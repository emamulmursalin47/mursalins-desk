    ...
    },
    {
      ...
      render: (r) => (
        <div className="flex items-center gap-2">
          <button onClick={(e) => { e.stopPropagation(); router.push(`/dashboard/experiences/${r.id}/edit`); }} className="cursor-pointer text-xs font-medium text-primary-600 hover:text-primary-500">Edit</button>
  ...
  return (
    <div ref={containerRef}>
      ...
      {loading ? <LoadingState /> : (
        <div data-animate>
          <DataTable columns={columns} data={experiences} keyExtractor={(r) => r.id} onRowClick={(r) => router.push(`/dashboard/experiences/${r.id}/edit`)} emptyMessage="No experiences found. Add your first work experience to get started." />
        </div>
      )}
